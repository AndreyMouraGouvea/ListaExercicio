...
namespace Lista
{
    class Program
    {
        ...
        {
        // 6 - Elabore um programa de calculadora com as operações básicas, apresentando um menu com as opções das operações
        // e uma opção 0-Sair, o programa só encerra se o usuário escolher 0 para sair.
